...
def infer_single_slide(model, features, label, reverse_label_dict, k=1):
	...
	with torch.no_grad():
		if isinstance(model, (CLAM_SB, CLAM_MB,TransformerMIL,TOAD_fc_mtl_concat)):
...
if __name__ == '__main__':
	...
	# 				patch.save(os.path.join(sample_save_dir, '{}_{}_x_{}_y_{}_a_{:.3f}.png'.format(idx, slide_id, s_coord[0], s_coord[1], s_score)))
		...
		if os.path.isfile(os.path.join(r_slide_save_dir, heatmap_save_name)):
			...
			heatmap.save(os.path.join(r_slide_save_dir, '{}_blockmap.png'.format(slide_id)))  #TCGA-UW-A7GI-01Z-00-DX1.4A1709FC-F8F3-4509-A011-10CBF1B53DA9_blockmap.png
			del heatmap
